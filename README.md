...
1. `MRK-002`: build the marker list with filters and sorting.
2. `MRK-003`: build marker detail and edit form.
3. `TAX-002`: build category management UI and commands.
